...
urlpatterns = [
    ...
    url(r'^user_info/(?P<user_id>[0-9]+)/$', views.show_user_info,
        name='show_user_info'),
    ...
    url(r'^device_info/(?P<device_id>[0-9]+)/$', views.show_device_info,
        name='show_device_info'),
    url(r'^add_device/', views.add_new_device, name='add_new_device'),
]
